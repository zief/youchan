...
//cek apakah ada variabel content / data yg di kirim dari controller, kalo gk ada, content = kosong
if(isset($content)){
...
//$poin = $this->Modelyouchan->cek_poin($id)->result();
...
<nav class="navbar navbar-default no-margin">
    <!-- Brand and toggle get grouped for better mobile display -->
                <div class="navbar-header fixed-brand">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url();?>"><i class="fa fa-rocket fa-4"></i> Youchan</a>
                </div><!-- navbar-header-->
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                <li class="active">
                    <a href="<?php echo base_url();?>user/home"><span class="fa-stack fa-lg pull-left"><i class="fa fa-home 
                ...
                <li>
                    <a href="<?php echo base_url();?>situs/faq"><span class="fa-stack fa-lg pull-left"><i class="fa fa-question fa-stack-1x "></i></span> FAQ</a>
                </li>
                <li>
